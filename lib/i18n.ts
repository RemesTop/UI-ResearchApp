...
const messages: Record<Locale, Messages> = {
    ...
    intro: {
      ...
      steps: [
        { label: "Tutki sivuja", desc: "Nettisivut ovat prototyyppejä, joten kaikki toiminnot eivät ole aitoja. Arvioi niitä ulkoasun ja yleisen käyttötuntuman perusteella." },
        { label: "Vastaa upotettuun Webropol-kyselyyn", desc: "Kysely on yksi jatkuva lomake, joka alkaa taustakysymyksillä. Vastaa kunkin sivun kysymykset ennen etenemistä." },
        { label: "Vaihda seuraavalle sivulle", desc: "Paina kyselynäkymässä 'Seuraava sivu', kun olet vastannut käyttöliittymän 1 kysymyksiin." },
  ...
  en: {
    intro: {
      ...
      steps: [
        { label: "Explore the pages", desc: "The websites are prototypes, so not all features are real. Evaluate them based on their appearance and overall feel." },
        { label: "Answer the embedded Webropol survey", desc: "The survey is one continuous form that starts with background questions. Answer each page's questions before moving on." },
        { label: "Move to the next page", desc: "Press 'Next page' in the survey view after completing interface 1's questions." },
